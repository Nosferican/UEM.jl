__precompile__()
	...
	import StatsBase: CoefTable, RegressionModel, adjr2, coef, coeftable, confint, deviance, dof, dof_residual, fitted, loglikelihood, model_response, nobs, nulldeviance, predict, residuals, r2, stderr, vcov
